...
#define TCAPI_E_WRONG_OPTION				MAKE_TCAPI_ERROR(12)
#define TCAPI_E_CANT_START_ENCPOOL			MAKE_TCAPI_ERROR(13)
#define TCAPI_E_TC_INSTALLED				MAKE_TCAPI_ERROR(14)
#define TCAPI_E_DRIVER_NOT_FOUND			MAKE_TCAPI_ERROR(15)
#define TCAPI_E_CANT_OPEN_SCM				MAKE_TCAPI_ERROR(16)
#define TCAPI_E_NOACCESS_SCM				MAKE_TCAPI_ERROR(17)
#define TCAPI_E_CANT_CREATE_SERVICE			MAKE_TCAPI_ERROR(18)
#define TCAPI_E_CANT_START_SERVICE			MAKE_TCAPI_ERROR(19)
#define TCAPI_E_CANT_GET_DRIVER_VER			MAKE_TCAPI_ERROR(20)
#define TCAPI_E_WRONG_DRIVER_VER			MAKE_TCAPI_ERROR(21)
#define TCAPI_E_CANT_LOAD_DRIVER			MAKE_TCAPI_ERROR(22)
#define TCAPI_E_INCONSISTENT_DRIVER_STATE	MAKE_TCAPI_ERROR(23)
#define TCAPI_E_CANT_ACQUIRE_DRIVER			MAKE_TCAPI_ERROR(24)
#define TCAPI_E_DRIVER_NOT_INSTALLED		MAKE_TCAPI_ERROR(25)
...
#define TCAPI_W_STALE_SERVICE				MAKE_TCAPI_WARNING(8)
